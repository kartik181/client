...
export async function handleSubscriptionDeleted({
    ...
    console.log('Sunscription deleted', subscriptionId)
...
export async function handleCheckOutSeesionCompleted({
    session,
    stripe,
}:{
...
async function createPayments({session, priceId, userEmail, sql}:{
    sql:any
    session: Stripe.Checkout.Session;
    priceId: string;
    userEmail:string
