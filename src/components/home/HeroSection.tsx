    ...
    >
      ...
      <div className="mb-6">
        ...
        >
          <Badge
            variant={"secondary"}
            className="relative px-6 py-2 text-base font-medium mb-0.5 bg-white rounded-full group-hover:bg-gray-50 transition-colors duration-200"
          >
      ...
      <MotionH1
        variants={itemVariants}
        className="font-bold py-6 text-center text-2xl sm:text-3xl lg:text-4xl"
      >
        Transform PDF into{" "}
